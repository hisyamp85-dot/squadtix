      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="space-y-6">
          ...
          <div class="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-6">
            ...
            <div class="mb-2 text-xs text-gray-500 dark:text-gray-400" v-if="storedUser">
          ...
          <div class="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-6 min-h-[320px]">
            ...
            <div v-if="scanResult" class="space-y-4">
              <div
                ...
                :class="scanResult.status === 'success'
...
const breadcrumbs = computed(() => {
  if (!userId.value) {
    return [
      { text: 'Home', to: '/' },
      { text: 'Check-in Barcode', active: true },
    ]
  }
  return [
...
const goToLogs = () => {
  if (userId.value) {
    router.push(`/${userId.value}/checkin/logs`)
  } else {
    router.push('/login')
  }
}
